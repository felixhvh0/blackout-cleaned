...
public class MoveEvent {
   ...
   public static class Pre extends Cancellable {
      ...
      public Vec3d originalMovement = new Vec3d(0.0D, 0.0D, 0.0D);
      public Vec3d movement = new Vec3d(0.0D, 0.0D, 0.0D);
      public MovementType movementType;
      public int xzValue;
      public int yValue;

      public Pre() {
         this.movementType = MovementType.field_6308;
         this.xzValue = 0;
         this.yValue = 0;
      }

      public static MoveEvent.Pre get(Vec3d movement, MovementType type) {
