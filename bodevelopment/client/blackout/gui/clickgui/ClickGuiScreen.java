...
public class ClickGuiScreen {
   ...
   public void onRender(float frameTime, double mouseX, double mouseY) {
      ...
      frameBuffer.start();
      float popUpDelta = (float)MathHelper.method_53062(System.currentTimeMillis() - this.openTime, 0L, 500L) / 500.0F;
   ...
   private float getAlpha() {
      if (BlackOut.mc.field_1755 instanceof ClickGui) {
         return Managers.CLICK_GUI.CLICK_GUI.isOpen() ? (float)MathHelper.method_53062(System.currentTimeMillis() - Managers.CLICK_GUI.CLICK_GUI.toggleTime, 0L, 200L) / 200.0F : 1.0F - (float)MathHelper.method_53062(System.currentTimeMillis() - Managers.CLICK_GUI.CLICK_GUI.toggleTime, 0L, 200L) / 200.0F;
      } else {
         return 1.0F;
      }
   }
