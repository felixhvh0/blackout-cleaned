...
public class ModuleComponent extends Component {
   ...
   private void updateAnimation() {
      ...
      float animationTime = MathHelper.method_15363(dist / 100.0F, 1.0F, 10.0F);
      this.openProgress = MathHelper.method_15363(this.openProgress + (this.opened ? this.frameTime * 20.0F / animationTime : -this.frameTime * 20.0F / animationTime), 0.0F, 1.0F);
      this.maxLength = MathHelper.method_16439((float)AnimUtils.easeInOutSine((double)this.openProgress), this.getHeight(), this.length);
   }
   ...
   private float getX() {
      float closedX = (Boolean)GuiSettings.getInstance().centerXClosed.get() ? (float)this.x + this.width / 2.0F - BlackOut.FONT.getWidth(this.module.getDisplayName()) / 2.0F * this.getScale() : MathHelper.method_16439(((Double)GuiSettings.getInstance().moduleXClosed.get()).floatValue(), (float)(this.x + 8), (float)this.x + this.width - this.getScale() * BlackOut.FONT.getWidth(this.module.getDisplayName()) - 38.0F);
      float openX = (Boolean)GuiSettings.getInstance().centerX.get() ? (float)this.x + this.width / 2.0F - BlackOut.FONT.getWidth(this.module.getDisplayName()) / 2.0F * this.getScale() : MathHelper.method_16439(((Double)GuiSettings.getInstance().moduleX.get()).floatValue(), (float)(this.x + 8), (float)this.x + this.width - this.getScale() * BlackOut.FONT.getWidth(this.module.getDisplayName()) - 38.0F);
      return MathHelper.method_16439(this.openProgress, closedX, openX);
   }

   private float getY() {
      return MathHelper.method_16439(MathHelper.method_16439(this.openProgress, ((Double)GuiSettings.getInstance().moduleYClosed.get()).floatValue(), ((Double)GuiSettings.getInstance().moduleY.get()).floatValue()), (float)(this.y + 8), Math.max((float)(this.y + 8), (float)this.y + this.getHeight() - 14.0F - this.getScale() * BlackOut.FONT.getHeight()));
   }

   private float getScale() {
      return MathHelper.method_16439(this.openProgress, ((Double)GuiSettings.getInstance().moduleScaleClosed.get()).floatValue(), ((Double)GuiSettings.getInstance().moduleScale.get()).floatValue());
   }

   private float getHeight() {
      return MathHelper.method_16439(this.openProgress, ((Double)GuiSettings.getInstance().moduleHeightClosed.get()).floatValue(), ((Double)GuiSettings.getInstance().moduleHeight.get()).floatValue());
   }
