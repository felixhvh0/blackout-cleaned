...
public class ClickGui extends Screen {
   ...
   public ClickGui() {
      super(Text.method_30163("Click GUI"));
   ...
   public void method_25394(DrawContext context, int mouseX, int mouseY, float delta) {
      if (this.open) {
         popUpDelta = (float)MathHelper.method_53062(System.currentTimeMillis() - this.toggleTime, 0L, 500L) / 500.0F;
         scale = (float)AnimUtils.easeOutBack((double)popUpDelta);
      } else {
         popUpDelta = 1.0F - (float)MathHelper.method_53062(System.currentTimeMillis() - this.toggleTime, 0L, 250L) / 250.0F;
         if (popUpDelta <= 0.0F) {
            this.method_25419();
         }
   ...
   private void renderFade() {
      ...
      renderer.startRender(this.stack, DrawMode.field_27381);
      ...
      for(i = 90; i >= 0; i -= 9) {
         ...
         renderer.vertex(width + (float)Math.cos(Math.toRadians((double)i)) * 10.0F, height + y, 0.0F, (float)GuiColorUtils.bg1.getRed() / 255.0F, (float)GuiColorUtils.bg1.getGreen() / 255.0F, (float)GuiColorUtils.bg1.getBlue() / 255.0F, MathHelper.method_37960(y, -10.0F, 10.0F));
      }
      ...
      for(i = 360; i >= 270; i -= 9) {
         y = (float)(Math.sin(Math.toRadians((double)i)) * 10.0D);
         renderer.vertex(width + (float)Math.cos(Math.toRadians((double)i)) * 10.0F, y, 0.0F, (float)GuiColorUtils.bg1.getRed() / 255.0F, (float)GuiColorUtils.bg1.getGreen() / 255.0F, (float)GuiColorUtils.bg1.getBlue() / 255.0F, MathHelper.method_37960(y, 10.0F, -10.0F));
      }
   ...
   private void renderLogo() {
      ...
      if (!(alpha <= 0.0F)) {
         ...
         t.startRender(this.stack, cx - ts / 2.0F, cy - ts / 2.0F, ts, ts, 1.0F, 1.0F, 1.0F, 1.0F, alpha, DrawMode.field_27381);
   ...
   private int getColumns() {
      return MathHelper.method_15340((int)((width - 200.0F) / 320.0F), 1, 4);
   }
