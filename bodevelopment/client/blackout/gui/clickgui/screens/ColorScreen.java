...
public class ColorScreen extends ClickGuiScreen {
   ...
   private void handleSliders() {
      ...
      case 1:
         progress = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, 0.0D, 500.0D), 0.0D, 1.0D);
         float clickBri = (float)(1.0D - MathHelper.method_15350(MathHelper.method_15370(this.my, 10.0D, 210.0D), 0.0D, 1.0D));
         float[] HSB = this.getHSB(false);
         red = Color.HSBtoRGB(HSB[0], progress, clickBri);
         green = Argb.method_27765(red);
         blue = Argb.method_27766(red);
         int blue = Argb.method_27767(red);
      ...
      case 2:
         ...
         red = Argb.method_27765(rgb);
         green = Argb.method_27766(rgb);
         blue = Argb.method_27767(rgb);
         this.colorSetting.get().set(red, green, blue);
         break;
      case 3:
         progress = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, 255.0D, 500.0D), 0.0D, 1.0D) * 255.0F;
      ...
      case 5:
         ...
         break;
      case 6:
         progress = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, 0.0D, 245.0D), 0.0D, 1.0D) * 255.0F;
         this.colorSetting.get().setAlpha((int)progress);
         break;
      case 7:
         progress = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, 0.0D, 245.0D), 0.0D, 1.0D);
         HSB = this.getHSB(false);
   ...
   private void handleThemeSliders() {
      switch(this.selecting) {
      case 1:
         this.colorSetting.saturation = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, 0.0D, 500.0D), 0.0D, 1.0D) * 2.0F - 1.0F;
         break;
      case 2:
         this.colorSetting.brightness = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, 0.0D, 500.0D), 0.0D, 1.0D) * 2.0F - 1.0F;
         break;
      case 3:
         this.colorSetting.alpha = (int)(MathHelper.method_15350(MathHelper.method_15370(this.mx, 0.0D, 500.0D), 0.0D, 1.0D) * 255.0D);
      }
   ...
   private void setValue(ColorScreen.ColorField colorField, int id) {
      ...
      val = MathHelper.method_15340(val, 0, 255);
      float[] hsb;
      int rgb;
      switch(id) {
      case 0:
      ...
      case 4:
         ...
         this.colorSetting.get().set(Argb.method_27765(rgb), Argb.method_27766(rgb), Argb.method_27767(rgb));
         break;
      case 5:
         hsb = this.getHSB(false);
   ...
   private void renderHueBar(float x, float y, float w, float h) {
      ...
      float hueX;
      if (this.selecting == 2) {
         hueX = (float)MathHelper.method_15350(this.mx, 0.0D, 500.0D);
      } else {
         hueX = MathHelper.method_16439(hue, x, x + w);
      }

      this.prevHueX = MathHelper.method_37166(this.prevHueX, hueX, this.frameTime * 20.0F);
      RenderUtils.roundedShadow(this.stack, this.prevHueX, y, 0.0F, h, 0.0F, 10.0F, (new Color(0, 0, 0, 100)).getRGB());
      RenderUtils.quad(this.stack, this.prevHueX - 3.0F, y - 2.0F, 6.0F, h + 4.0F, Color.HSBtoRGB(MathHelper.method_37960(this.prevHueX, 0.0F, 500.0F), 1.0F, 1.0F));
   }
   ...
   private void renderThemeBar(float x, float y, float w, int id, float number, float p, String name) {
      this.themeX[id] = MathHelper.method_16439(Math.min(this.frameTime * 20.0F, 1.0F), this.themeX[id], p);
      Color left;
      Color right;
      switch(id) {
      case 1:
   ...
   private void renderBar(float x, float y, float w, int id, float p, String name) {
      this.colorX[id] = MathHelper.method_16439(Math.min(this.frameTime * 20.0F, 1.0F), this.colorX[id], p);
   ...
   private void renderPicker() {
      ...
      int red = Argb.method_27765(rgb);
      int green = Argb.method_27766(rgb);
      int blue = Argb.method_27767(rgb);
      ...
      if (this.colorSetting.theme == 0 && this.selecting == 1) {
         circleX = (float)MathHelper.method_15350(this.mx, 0.0D, 500.0D);
         circleY = (float)MathHelper.method_15350(this.my, 10.0D, 210.0D);
      } else {
         float[] HSB = this.getHSB(false);
         circleX = HSB[1] * 500.0F;
         circleY = (float)MathHelper.method_48781(HSB[2], 210, 10);
      }

      this.prevCircleX = MathHelper.method_37166(this.prevCircleX, circleX, this.frameTime * 20.0F);
      this.prevCircleY = MathHelper.method_37166(this.prevCircleY, circleY, this.frameTime * 20.0F);
