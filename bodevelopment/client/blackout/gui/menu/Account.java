...
public class Account {
   ...
   public Account(String script) {
      ...
      this.uuid = Uuids.method_43344(this.name);
      this.accessToken = "";
      this.xuid = Optional.empty();
      this.clientId = Optional.empty();
      this.accountType = AccountType.field_1988;
   }
   ...
   public Account(String name, String script, UUID uuid, String accessToken, Optional<String> xuid, Optional<String> clientId, AccountType accountType) {
      this.name = name;
      this.script = script;
      this.uuid = uuid;
   ...
   public Account.AccountClickResult onClick(float clickX, float clickY, int button, boolean pressed) {
      if (!pressed) {
         ...
         float dx = MathHelper.method_15363(clickX, 0.0F, 500.0F) - clickX;
         float dy = MathHelper.method_15363(clickY, 0.0F, 65.0F) - clickY;
   ...
   private AccountType getAccountType(String from) {
      ...
      AccountType var10000;
      switch(var3) {
      case 0:
         var10000 = AccountType.field_34962;
         break;
      case 1:
         var10000 = AccountType.field_1990;
         break;
      case 2:
         var10000 = AccountType.field_1988;
         break;
      default:
