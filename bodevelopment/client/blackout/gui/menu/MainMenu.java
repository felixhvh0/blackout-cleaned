...
public class MainMenu {
   ...
   public MainMenu() {
      Runnable[] var10001 = new Runnable[]{() -> {
         BlackOut.mc.method_1507(new SelectWorldScreen(this.titleScreen));
      }, () -> {
         BlackOut.mc.method_1507(new MultiplayerScreen(this.titleScreen));
      }, () -> {
         ...
         BlackOut.mc.method_1507(new OptionsScreen(this.titleScreen, BlackOut.mc.field_1690));
      }, null};
      MinecraftClient var10004 = BlackOut.mc;
      Objects.requireNonNull(var10004);
      var10001[4] = var10004::method_1592;
      this.runnables = var10001;
      BlackOut.EVENT_BUS.subscribe(this, () -> {
         return !(BlackOut.mc.field_1755 instanceof TitleScreen);
      });
   }
   ...
   public void set(TitleScreen titleScreen) {
   ...
   public void render(int mouseX, int mouseY, float delta) {
      ...
      float menuAlpha = MathHelper.method_15363(MathHelper.method_37960(switchProgress, 0.4F, 0.0F), 0.0F, 1.0F);
      float altManagerAlpha = MathHelper.method_15363(MathHelper.method_37960(switchProgress, 0.6F, 1.0F), 0.0F, 1.0F);
   ...
   private void openLink(String string) {
      Util.method_668().method_670(string);
   }
