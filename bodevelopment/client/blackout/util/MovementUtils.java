...
public class MovementUtils {
   ...
   public static double getEffectMulti() {
      ...
      if (BlackOut.mc.field_1724.method_6059(StatusEffects.field_5904)) {
         multiBonus += (double)BlackOut.mc.field_1724.method_6112(StatusEffects.field_5904).method_5578() * 0.2D + 0.2D;
      }

      if (BlackOut.mc.field_1724.method_6059(StatusEffects.field_5909)) {
         multiBonus -= (double)BlackOut.mc.field_1724.method_6112(StatusEffects.field_5909).method_5578() * 0.2D + 0.2D;
      }
