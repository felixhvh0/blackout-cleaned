      ...
      synchronized(this.timers) {
         this.timers.removeIf((item) -> {
            if (System.currentTimeMillis() > item.endTime) {
               ...
               consumer.accept(item.value, (double)(System.currentTimeMillis() - item.startTime) / 1000.0D, MathHelper.method_15350(MathHelper.method_15370((double)System.currentTimeMillis(), (double)item.startTime, (double)item.endTime), 0.0D, 1.0D));
               return false;
            }
         });
      }
