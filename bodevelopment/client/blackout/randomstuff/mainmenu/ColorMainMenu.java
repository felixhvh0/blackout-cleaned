...
public class ColorMainMenu implements MainMenuRenderer {
   private final CubeMapRenderer PANORAMA_CUBE_MAP = new CubeMapRenderer(new Identifier("textures/gui/title/background/panorama"));
   private final RotatingCubeMapRenderer backgroundRenderer;

   public ColorMainMenu() {
      this.backgroundRenderer = new RotatingCubeMapRenderer(this.PANORAMA_CUBE_MAP);
   }
   ...
   private void renderButtons(MatrixStack stack) {
      stack.method_22903();
   ...
   private void renderButton(MatrixStack stack, String name) {
      RenderUtils.drawLoadedBlur("title", stack, (renderer) -> {
