...
public class TextureRenderer extends Renderer {
   ...
   public static void renderRounded(MatrixStack stack, float x, float y, float width, float height, float u1, float v1, float u2, float v2, float rad, int steps, BOTextures.Texture texture) {
      INSTANCE.setTexture(texture.getId());
      INSTANCE.startRender(stack, x - rad, y - rad, width + rad * 2.0F, height + rad * 2.0F, u1, v1, u2, v2, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F, DrawMode.field_27381);
      INSTANCE.rounded(x, y, width, height, rad, steps);
      INSTANCE.endRender();
   }

   public static void renderFitRounded(MatrixStack stack, float x, float y, float width, float height, float u1, float v1, float u2, float v2, float rad, int steps, BOTextures.Texture texture) {
      renderFitRounded(stack, x, y, width, height, u1, v1, u2, v2, rad, steps, texture.getId());
   }

   public static void renderFitRounded(MatrixStack stack, float x, float y, float width, float height, float u1, float v1, float u2, float v2, float rad, int steps, int id) {
      INSTANCE.setTexture(id);
      INSTANCE.startRender(stack, x, y, width, height, u1, v1, u2, v2, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F, DrawMode.field_27381);
   ...
   public static void renderCircle(MatrixStack stack, float x, float y, float u1, float v1, float u2, float v2, float rad, int steps, int id) {
      INSTANCE.setTexture(id);
      INSTANCE.startRender(stack, x - rad, y - rad, rad * 2.0F, rad * 2.0F, u1, v1, u2, v2, 0.0F, 1.0F, 1.0F, 1.0F, 1.0F, DrawMode.field_27381);
   ...
   public void quadUV(MatrixStack stack, float x, float y, float w, float h, float u1, float v1, float u2, float v2, float blur, float r, float g, float b, float a) {
      this.startRender(stack, x, y, w, h, u1, v1, u2, v2, blur, r, g, b, a, DrawMode.field_27382);
      this.vertex(x, y);
      this.vertex(x, y + h);
      this.vertex(x + w, y + h);
      this.vertex(x + w, y);
   ...
   public void quadUV(MatrixStack stack, float x, float y, float w, float h, float u1, float v1, float u2, float v2, float blur, float r, float g, float b, float a, Shader shader, ShaderSetup setup) {
      this.startRender(stack, x, y, w, h, u1, v1, u2, v2, blur, r, g, b, a, DrawMode.field_27382);
      this.vertex(x, y);
      this.vertex(x, y + h);
      this.vertex(x + w, y + h);
   ...
   public void startRender(MatrixStack stack, float x, float y, float w, float h, float blur, float r, float g, float b, float a, DrawMode drawMode) {
      this.startRender(stack, x, y, w, h, 0.0F, 0.0F, 1.0F, 1.0F, blur, r, g, b, a, drawMode);
   }

   public void startRender(MatrixStack stack, float x, float y, float w, float h, float u1, float v1, float u2, float v2, float blur, float r, float g, float b, float a, DrawMode drawMode) {
      ...
      (this.renderBuffer = Tessellator.method_1348().method_1349()).method_1328(drawMode, VertexFormats.field_1592);
   }
