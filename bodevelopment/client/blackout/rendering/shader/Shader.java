...
public class Shader {
   ...
   public void render(BufferBuilder bufferBuilder, ShaderSetup shaderSetup) {
      ...
      BuiltBuffer builtBuffer = bufferBuilder.method_1326();
      VertexBuffer vertexBuffer = builtBuffer.method_43583().comp_749().method_43446();
   ...
   private void draw(VertexBuffer vertexBuffer) {
      ...
      this.unbind();
      GlProgramManager.method_22094(this.currentShader[0]);
   }
   ...
   public void bind() {
      GlProgramManager.method_22094(this.id);
