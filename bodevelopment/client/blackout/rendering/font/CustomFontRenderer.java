...
public class CustomFontRenderer {
   ...
   public void text(MatrixStack stack, String string, float s, float textX, float textY, Color color, boolean xCenter, boolean yCenter, Shader shader, ShaderSetup setup) {
      this.textInternal(stack, string, s, textX, textY, color.getRGB(), xCenter, yCenter, shader, setup);
   }

   public void text(MatrixStack stack, String string, float s, float textX, float textY, int color, boolean xCenter, boolean yCenter, Shader shader, ShaderSetup setup) {
      this.textInternal(stack, string, s, textX, textY, color, xCenter, yCenter, shader, setup);
   }

   private void textInternal(MatrixStack stack, String string, float s, float textX, float textY, int color, boolean xCenter, boolean yCenter, Shader shader, ShaderSetup setup) {
      stack.method_22903();
