...
public class ObsidianModule extends Module {
   ...
   public final Setting<List<Block>> supportBlocks;
   ...
   protected final List<BlockPos> insideBlocks;
   public final List<BlockPos> blockPlacements;
   private final List<BlockPos> supportPositions;
   protected final List<BlockPos> valids;
   private final TimerList<BlockPos> placed;
   private final RenderList<BlockPos> render;
   private final RenderList<BlockPos> supportRender;
   ...
   public ObsidianModule(String name, String description, SubCategory category) {
      ...
      this.supportBlocks = this.sgBlocks.bl("Support Blocks", "Blocks to use for support.", Blocks.field_10540);
         ...
         if (!((double)(System.currentTimeMillis() - this.lastAttack) < 1000.0D / (Double)this.attackSpeed.get())) {
            ...
            if (blocking != null) {
               if (!SettingUtils.shouldRotate(RotationType.Attacking) || this.attackRotate(blocking.method_5829(), -0.1D, "attacking")) {
                  ...
                  this.sendPacket(PlayerInteractEntityC2SPacket.method_34206(blocking, BlackOut.mc.field_1724.method_5715()));
   ...
   private Entity getBlocking() {
      ...
      while(var4.hasNext()) {
         ...
         if (entity instanceof EndCrystalEntity && !(BlackOut.mc.field_1724.method_5739(entity) > 5.0F) && SettingUtils.inAttackRange(entity.method_5829()) && this.validForBlocking(entity)) {
            ...
            if (this.blocksLeft > 0) {
               ...
               if (this.switched || this.hand != null) {
                  if (SettingUtils.shouldRotate(RotationType.BlockPlace) && this.rotationMode.get() == ObsidianModule.RotationMode.Packet) {
                     ...
                     this.sendPacket(new LookAndOnGround(rotation.yaw(), rotation.pitch(), Managers.PACKET.isOnGround()));
                  }
   ...
   protected BlockPos findSupport(BlockPos pos) {
      if (!OLEPOSSUtils.replaceable(pos)) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            ...
            if (dir != Direction.field_11036) {
               BlockPos pos2 = pos.method_10093(dir);
   ...
   protected boolean hasSupport(BlockPos pos, boolean check) {
      ...
      if (data.valid()) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (data2.valid()) {
               BlockPos offsetPos = pos.method_10093(dir);
   ...
   protected boolean intersects(PlayerEntity player) {
      Box playerBox = player.method_5829().method_35580(1.0E-4D, 1.0E-4D, 1.0E-4D);
      Iterator var3 = this.blockPlacements.iterator();
   ...
   protected BlockPos getPos() {
      return BlackOut.mc.field_1724 == null ? BlockPos.field_10980 : new BlockPos(BlackOut.mc.field_1724.method_31477(), (int)Math.round(BlackOut.mc.field_1724.method_23318()), BlackOut.mc.field_1724.method_31479());
   }
