...
public class IntSetting extends Setting<Integer> {
   ...
   public float render() {
      if (this.moving) {
         this.sliderPos = (float)MathHelper.method_15350(MathHelper.method_15370(this.mx, (double)(this.x + 10), (double)((float)this.x + this.width - 10.0F)), 0.0D, 1.0D);
         float val = (float)MathHelper.method_48781(this.sliderPos, this.min, this.max);
         this.setValue(Math.round(val / (float)this.step) * this.step);
      } else {
         this.sliderPos = MathHelper.method_15363(MathHelper.method_37960((float)(Integer)this.get(), (float)this.min, (float)this.max), 0.0F, 1.0F);
      }
      ...
      this.sliderAnim = MathHelper.method_15363(MathHelper.method_37166(this.sliderAnim, this.sliderPos, this.frameTime * 20.0F), 0.0F, 1.0F);
