...
public class ColorSetting extends Setting<BlackOutColor> {
   ...
   private BlackOutColor modifyTheme(int theme) {
      float[] HSB = Color.RGBtoHSB(Argb.method_27765(theme), Argb.method_27766(theme), Argb.method_27767(theme), new float[3]);
      HSB[1] = MathHelper.method_15363(HSB[1] + this.saturation, 0.0F, 1.0F);
      HSB[2] = MathHelper.method_15363(HSB[2] + this.brightness, 0.0F, 1.0F);
   ...
   public void set(JsonElement element) {
      ...
      if (strings.length != 5) {
         ...
         this.saturation = MathHelper.method_15363(Float.parseFloat(strings[2]), -1.0F, 1.0F);
         this.brightness = MathHelper.method_15363(Float.parseFloat(strings[3]), -1.0F, 1.0F);
