...
public class Step extends Module {
   ...
   public boolean canStrafeJump(Vec3d movement) {
      if (!this.enabled) {
         ...
         List<VoxelShape> list = BlackOut.mc.field_1687.method_20743(BlackOut.mc.field_1724, box.method_18804(movement));
         Vec3d vec3d = movement.method_1027() == 0.0D ? movement : Entity.method_20736(BlackOut.mc.field_1724, movement, box, BlackOut.mc.field_1687, list);
         ...
         if (!collidedHorizontally) {
            ...
            Vec3d stepMovement = Entity.method_20736(BlackOut.mc.field_1724, new Vec3d(movement.field_1352, 0.6D, movement.field_1350), box, BlackOut.mc.field_1687, list);
            Vec3d stepMovementUp = Entity.method_20736(BlackOut.mc.field_1724, new Vec3d(0.0D, 0.6D, 0.0D), box.method_1012(movement.field_1352, 0.0D, movement.field_1350), BlackOut.mc.field_1687, list);
            if (stepMovementUp.field_1351 < (Double)this.height.get()) {
               Vec3d vec3d4 = Entity.method_20736(BlackOut.mc.field_1724, new Vec3d(movement.field_1352, 0.0D, movement.field_1350), box.method_997(stepMovementUp), BlackOut.mc.field_1687, list).method_1019(stepMovementUp);
