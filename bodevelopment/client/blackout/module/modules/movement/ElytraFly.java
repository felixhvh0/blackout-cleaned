...
public class ElytraFly extends Module {
   ...
   public void onTick(TickEvent.Pre event) {
      if (this.mode.get() == ElytraFly.Mode.Bounce && BlackOut.mc.field_1724 != null) {
         ...
         if (this.sinceFalling <= 1 && BlackOut.mc.field_1724.method_24828()) {
            ...
            Managers.PACKET.sendInstantly(new ClientCommandC2SPacket(BlackOut.mc.field_1724, net.minecraft.network.packet.c2s.play.ClientCommandC2SPacket.Mode.field_12982));
         }
   ...
   public float getPitch() {
      return this.sus ? BlackOut.mc.field_1724.method_36455() : MathHelper.method_37166(((Double)this.slowPitch.get()).floatValue(), ((Double)this.fastPitch.get()).floatValue(), (float)BlackOut.mc.field_1724.method_18798().method_1033());
   }
