...
public class Flight extends Module {
   ...
   public void onEnable() {
      ...
      if (this.mode.get() == Flight.Mode.VerusDMG) {
         ...
         this.sendPacket(new PositionAndOnGround(BlackOut.mc.field_1724.method_23317(), BlackOut.mc.field_1724.method_23318() + (Double)this.verusDMGheight.get(), BlackOut.mc.field_1724.method_23321(), false));
         this.sendPacket(new PositionAndOnGround(BlackOut.mc.field_1724.method_23317(), BlackOut.mc.field_1724.method_23318(), BlackOut.mc.field_1724.method_23321(), false));
         this.sendPacket(new PositionAndOnGround(BlackOut.mc.field_1724.method_23317(), BlackOut.mc.field_1724.method_23318(), BlackOut.mc.field_1724.method_23321(), true));
      }
      ...
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         ...
         case Verus:
            ...
            if (!BlackOut.mc.field_1724.method_24828()) {
               this.placeBlock(Hand.field_5808, pos.method_46558(), Direction.field_11036, pos);
            }
