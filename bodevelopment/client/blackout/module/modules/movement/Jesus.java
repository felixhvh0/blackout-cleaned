...
public class Jesus extends Module {
   ...
   public void onMove(MoveEvent.Pre event) {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         if (BlackOut.mc.field_1687.method_8320(BlackOut.mc.field_1724.method_24515().method_10074()).method_26204() != Blocks.field_10382 && BlackOut.mc.field_1687.method_8320(BlackOut.mc.field_1724.method_24515()).method_26204() != Blocks.field_10382) {
            this.inWater = false;
         } else {
            if (!this.inWater) {
               this.isSlowed = false;
   ...
   private void tickNCP(MoveEvent.Pre event) {
      double height = OLEPOSSUtils.fluidHeight(BlackOut.mc.field_1724.method_5829(), FluidTags.field_15517);
      if (!(height <= 0.0D)) {
   ...
   private void tickFast(MoveEvent.Pre event) {
      if (BlackOut.mc.field_1724.method_5799() && !BlackOut.mc.field_1724.method_5869() || BlackOut.mc.field_1724.method_5771() && !BlackOut.mc.field_1724.method_5777(FluidTags.field_15518)) {
         ((IVec3d)BlackOut.mc.field_1724.method_18798()).blackout_Client$setY((Double)this.bob.get());
         if ((Boolean)this.toggle.get() && (!BlackOut.mc.field_1724.method_5771() || BlackOut.mc.field_1724.method_5777(FluidTags.field_15518)) && !this.isSlowed) {
            double motion = MovementUtils.getSpeed((Double)this.waterSpeed.get());
            if (BlackOut.mc.field_1724.method_6059(StatusEffects.field_5904)) {
               motion *= 1.2D + (double)BlackOut.mc.field_1724.method_6112(StatusEffects.field_5904).method_5578() * 0.2D;
            }

            if (BlackOut.mc.field_1724.method_6059(StatusEffects.field_5909)) {
               motion /= 1.2D + (double)BlackOut.mc.field_1724.method_6112(StatusEffects.field_5909).method_5578() * 0.2D;
            }
