...
public class Strafe extends Module {
   ...
   public Strafe() {
      ...
      this.yaw = 0.0D;
      this.og = 0;
      this.prevMovement = Vec3d.field_1353;
   ...
   public void onReceive(PacketEvent.Receive.Pre event) {
      if ((Boolean)this.damageBoost.get() && this.enabled) {
         if (event.packet instanceof PlayerPositionLookS2CPacket) {
            ...
            if (var4 instanceof EntityVelocityUpdateS2CPacket) {
               EntityVelocityUpdateS2CPacket packet = (EntityVelocityUpdateS2CPacket)var4;
               if (BlackOut.mc.field_1724 == null || BlackOut.mc.field_1724.method_5628() != packet.method_11818()) {
                  return;
               }

               vel = (new Vec3d((double)((float)packet.method_11815() / 8000.0F), (double)((float)packet.method_11816() / 8000.0F), (double)((float)packet.method_11819() / 8000.0F))).method_1020(this.getVelocity());
            }

            var4 = event.packet;
            if (var4 instanceof ExplosionS2CPacket) {
               ExplosionS2CPacket packet = (ExplosionS2CPacket)var4;
               vel = new Vec3d((double)packet.method_11472(), (double)packet.method_11473(), (double)packet.method_11474());
            }
   ...
   private Vec3d getVelocity() {
      return !this.velocities.isEmpty() && (Integer)this.latencyTicks.get() != 0 ? (Vec3d)this.velocities.get(Math.min(this.velocities.size(), (Integer)this.latencyTicks.get()) - 1) : BlackOut.mc.field_1724.method_18798();
   }
   ...
   private float getTimer() {
      ...
      return MathHelper.method_37166(start, end, MathHelper.method_37960((float)this.og, (float)(Integer)this.timerStartProgress.get(), (float)(Integer)this.timerEndProgress.get()));
   }
   ...
   private double getFriction() {
      if ((Boolean)this.vanillaFriction.get()) {
         ...
         return MathHelper.method_15390((Double)this.startFriction.get(), (Double)this.endFriction.get(), l);
      }
   }

   private double getVanillaFriction() {
      BlockPos blockPos = BlackOut.mc.field_1724.method_23314();
   ...
   private boolean isPaused() {
      if ((Boolean)this.pauseSneak.get() && BlackOut.mc.field_1724.method_5715()) {
         ...
         case Touching:
            ...
            break;
         case Submerged:
            if (BlackOut.mc.field_1724.method_5777(FluidTags.field_15517)) {
               return true;
            }
            break;
         case Both:
            if (BlackOut.mc.field_1724.method_5799() || BlackOut.mc.field_1724.method_5777(FluidTags.field_15517)) {
               return true;
            }
         }
         ...
         case Touching:
            ...
            break;
         case Submerged:
            var10000 = BlackOut.mc.field_1724.method_5777(FluidTags.field_15518);
            break;
         case Both:
            var10000 = BlackOut.mc.field_1724.method_5771() || BlackOut.mc.field_1724.method_5777(FluidTags.field_15518);
            break;
         default:
            var10000 = false;
         }
