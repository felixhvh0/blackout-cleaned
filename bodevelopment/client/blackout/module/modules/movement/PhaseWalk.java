...
public class PhaseWalk extends Module {
   ...
   public void onDisable() {
      ...
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null && this.prevActive && (Boolean)this.resync.get()) {
         ...
         this.sendPacket(new Full(pos.field_1352, pos.field_1351 + 1.0D, pos.field_1350, Managers.ROTATION.prevYaw + 5.0F, Managers.ROTATION.prevPitch, false));
      }
            ...
            if ((Boolean)this.stopRotation.get()) {
               ...
               if (this.sinceRotation < (Integer)this.preTicks.get()) {
                  if ((Boolean)this.stopWait.get()) {
                     BlackOut.mc.field_1724.method_18799(new Vec3d(0.0D, BlackOut.mc.field_1724.method_18798().field_1351, 0.0D));
   ...
   private boolean preXZ(MoveEvent.Pre event) {
      Vec3d vec = MovementPrediction.predict(BlackOut.mc.field_1724);
      Vec3d vec2 = BlackOut.mc.field_1724.method_19538().method_1019(event.movement);
   ...
   private void handleDescend(MoveEvent.Pre event) {
      Vec3d vec3 = BlackOut.mc.field_1724.method_19538().method_1031(0.0D, -0.0253D, 0.0D);
   ...
   private void handleAscend(MoveEvent.Pre event) {
      ...
      Vec3d vec = BlackOut.mc.field_1724.method_19538().method_38499(Axis.field_11052, this.ascendY + offset);
      this.sendBounds(vec);
   ...
   private void handleXZ(MoveEvent.Pre event) {
      ...
      Vec3d vec3 = BlackOut.mc.field_1724.method_19538().method_1031(x, event.movement.field_1351, z).method_38499(Axis.field_11052, BlackOut.mc.field_1724.method_23318());
      this.sendBounds(vec3);
      BlackOut.mc.field_1724.method_33574(vec3);
      event.setXZ(this, 0.0D, 0.0D);
   }
   ...
   private void sendBounds(Vec3d to) {
      ...
      this.timerLeft = 5;
      Managers.PACKET.sendInstantly(new PositionAndOnGround(to.field_1352, to.field_1351, to.field_1350, Managers.PACKET.isOnGround()));
      Managers.PACKET.sendInstantly(new PositionAndOnGround(to.field_1352, to.field_1351 - 87.0D, to.field_1350, Managers.PACKET.isOnGround()));
