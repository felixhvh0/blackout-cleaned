...
public class FastFall extends Module {
   ...
   public void onReceive(PacketEvent.Receive.Pre event) {
      if (event.packet instanceof PlayerPositionLookS2CPacket && (Boolean)this.rbDisable.get()) {
   ...
   private boolean aboveHole() {
      for(double offset = 0.0D; offset < 7.0D; offset += 0.1D) {
         if (OLEPOSSUtils.inside(BlackOut.mc.field_1724, BlackOut.mc.field_1724.method_5829().method_989(0.0D, -offset, 0.0D))) {
            return HoleUtils.inHole(BlockPos.method_49638(BlackOut.mc.field_1724.method_19538().method_1031(0.0D, -offset + 0.12D, 0.0D)));
         }
      }
