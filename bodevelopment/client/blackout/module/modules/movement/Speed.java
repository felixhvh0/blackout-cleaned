...
public class Speed extends Module {
   ...
   public void onEnable() {
      if (BlackOut.mc.field_1724 != null) {
         ...
         this.yaw = MathHelper.method_15338(Math.toDegrees(Math.atan2(this.prevMovement.field_1350, this.prevMovement.field_1352)));
      }
   }
      ...
      if ((Boolean)this.pauseSneak.get() && BlackOut.mc.field_1724.method_5715()) {
         ...
         label87: {
            ...
            case Disabled:
               break;
            case Submerged:
               if (BlackOut.mc.field_1724.method_5777(FluidTags.field_15518)) {
                  break label87;
               }
               break;
            case Both:
               if (BlackOut.mc.field_1724.method_5771() || BlackOut.mc.field_1724.method_5777(FluidTags.field_15518)) {
                  break label87;
               }
               break;
            default:
