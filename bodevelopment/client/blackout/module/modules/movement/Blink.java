...
public class Blink extends Module {
   ...
   public void onEnable() {
      ...
      if (BlackOut.mc.field_1724 != null) {
         ...
         this.box = new Box(serverPos.field_1352 - this.box.method_17939() / 2.0D, serverPos.field_1351, serverPos.field_1350 - this.box.method_17941() / 2.0D, serverPos.field_1352 + this.box.method_17939() / 2.0D, serverPos.field_1351 + this.box.method_17940(), serverPos.field_1350 + this.box.method_17941() / 2.0D);
      }
