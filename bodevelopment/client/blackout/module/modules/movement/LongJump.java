...
public class LongJump extends Module {
   ...
   public LongJump() {
      ...
      this.phase = 0;
      this.prevMovement = new Vec3d(0.0D, 0.0D, 0.0D);
      this.ticks = 0;
      this.jumped = 0;
      ...
      if (event.packet instanceof PlayerPositionLookS2CPacket) {
         ...
         if (System.currentTimeMillis() - this.prevRubberband >= 1000L) {
            ...
            if (var4 instanceof EntityVelocityUpdateS2CPacket) {
               ...
               vel = (new Vec3d((double)((float)packet.method_11815() / 8000.0F), (double)((float)packet.method_11816() / 8000.0F), (double)((float)packet.method_11819() / 8000.0F))).method_1020(BlackOut.mc.field_1724.method_18798());
            }
