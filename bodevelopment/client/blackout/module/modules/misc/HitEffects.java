...
public class HitEffects extends Module {
   ...
   public HitEffects() {
      ...
      this.entities = this.sgEntities.el("Entities", ".", EntityType.field_6097);
   ...
   public void onSend(PacketEvent.Sent event) {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         ...
         if (var3 instanceof AccessorInteractEntityC2SPacket) {
            ...
            if (packet.getType().method_34211() == InteractType.field_29172) {
               Entity target = BlackOut.mc.field_1687.method_8469(packet.getId());
               if (target == null) {
                  return;
               }
   ...
   private void playSounds(Entity target) {
      if ((Boolean)this.hitSound.get()) {
         ...
         case Waltuh:
            ...
            break;
         case Critical:
            BlackOut.mc.field_1687.method_8486(target.method_23317(), target.method_23318() + 1.0D, target.method_23321(), SoundEvents.field_15016, SoundCategory.field_15248, ((Double)this.volume.get()).floatValue(), ((Double)this.pitch.get()).floatValue(), true);
         }
