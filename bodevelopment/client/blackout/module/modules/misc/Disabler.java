   ...
   public void onTickPre(TickEvent.Post event) {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         if ((Boolean)this.grimMovement.get()) {
            ...
            Hand hand = OLEPOSSUtils.getHand(Items.field_8547);
            if (hand == null) {
               FindResult result = ((SwitchMode)this.tridentSwitch.get()).find(Items.field_8547);
            ...
            if ((Boolean)this.b1.get()) {
               this.sendPacket(new PlayerInteractItemC2SPacket(hand == null ? Hand.field_5808 : hand, 0));
            }
