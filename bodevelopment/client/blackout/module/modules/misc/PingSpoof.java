...
public class PingSpoof extends Module {
   ...
   public void refresh() {
      if (System.currentTimeMillis() > this.nextJ) {
         ...
         this.nextJ = System.currentTimeMillis() + Math.round(MathHelper.method_16436(Math.random(), (double)((float)(Integer)this.jitterInterval.get() / 2.0F), (double)(Integer)this.jitterInterval.get() * 1.5D) * 50.0D);
      }

   }

   public boolean shouldDelay(Packet<?> packet) {
      return this.mode.get() == PingSpoof.SpoofMode.Real || packet instanceof CommonPongC2SPacket || packet instanceof KeepAliveC2SPacket;
   }
