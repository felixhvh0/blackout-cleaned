...
public class Suicide extends Module {
   ...
   public void onTick(TickEvent.Post event) {
      if (BlackOut.mc.field_1755 instanceof DeathScreen && (Boolean)this.disableDeath.get()) {
         this.disable("died");
      }
   ...
   private void dropArmor() {
      if ((Integer)this.dropArmor.get() >= 1) {
         ...
         for(Iterator var2 = this.toDrop((Integer)this.dropArmor.get()).iterator(); var2.hasNext(); dropped = true) {
            ...
            BlackOut.mc.field_1761.method_2906(0, 8 - equipmentSlot.method_5927(), 0, SlotActionType.field_7795, BlackOut.mc.field_1724);
         }

         if (dropped && BlackOut.mc.field_1724.field_7512 instanceof PlayerScreenHandler) {
   ...
   private List<EquipmentSlot> toDrop(int amount) {
      List<EquipmentSlot> list = (List)Arrays.stream(OLEPOSSUtils.equipmentSlots).filter((slot) -> {
         return BlackOut.mc.field_1724.method_31548().method_7372(slot.method_5927()).method_7909() instanceof ArmorItem;
