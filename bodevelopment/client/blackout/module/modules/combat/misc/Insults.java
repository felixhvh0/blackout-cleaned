   ...
   public void onReceive(PacketEvent.Receive.Pre event) {
      ...
      if (var3 instanceof EntityStatusS2CPacket) {
         ...
         if (packet.method_11470() == 35) {
            Entity entity = packet.method_11469(BlackOut.mc.field_1687);
            if ((Boolean)this.pop.get() && BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null && entity instanceof PlayerEntity && entity != BlackOut.mc.field_1724 && !Managers.FRIENDS.isFriend((PlayerEntity)entity) && BlackOut.mc.field_1724.method_19538().method_1022(entity.method_19538()) <= (double)(Integer)this.range.get()) {
            }
         }
      }
