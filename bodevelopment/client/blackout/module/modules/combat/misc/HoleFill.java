...
public class HoleFill extends Module {
   ...
   public HoleFill() {
      ...
      this.blocks = this.sgPlacing.bl("Blocks", "Blocks to use.", Blocks.field_10540);
      ...
      this.prevHole = BlockPos.field_10980;
      this.holeTime = 0L;
   }
   ...
   private void updateHoles() {
      ...
      BlockPos p = BlockPos.method_49638(BlackOut.mc.field_1724.method_33571());
   ...
   private boolean validHole(Hole hole) {
      ...
      if (this.selfNearCheck(hole)) {
         ...
         do {
            ...
            player = (AbstractClientPlayerEntity)var8.next();
   ...
   private boolean inHole(Vec3d vec) {
      BlockPos pos = new BlockPos((int)Math.floor(vec.method_10216()), (int)Math.round(vec.method_10214()), (int)Math.floor(vec.method_10215()));
