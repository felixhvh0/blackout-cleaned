...
public class Clip extends Module {
   ...
   public void onMove(MoveEvent.Pre event) {
      ...
      if (!(Boolean)this.pauseMove.get() || BlackOut.mc.field_1724.field_3913.field_3905 == 0.0F && BlackOut.mc.field_1724.field_3913.field_3907 == 0.0F) {
         if (!this.findCorner(currentX, currentZ, new BlockPos(BlackOut.mc.field_1724.method_31477(), (int)Math.round(BlackOut.mc.field_1724.method_23318()), BlackOut.mc.field_1724.method_31479()))) {
            double targetX = MathHelper.method_16436(this.cornerX, 0.3D, 0.7D);
            double targetZ = MathHelper.method_16436(this.cornerZ, 0.3D, 0.7D);
   ...
   private void wallMove(MoveEvent.Pre event, double targetX, double targetZ, double currentX, double currentZ) {
      if (this.ticksStill-- > 0) {
         ...
         double yaw = MathHelper.method_15338(Math.toDegrees(Math.atan2(targetZ - currentZ, targetX - currentX)) - 90.0D);
   ...
   private void sendBounds() {
      ...
      this.sendPacket(new PositionAndOnGround(bounds.field_1352, bounds.field_1351, bounds.field_1350, Managers.PACKET.isOnGround()));
   }
   ...
   private void sendPos(double x, double z, boolean onGround) {
      this.sendPacket(new PositionAndOnGround(x, BlackOut.mc.field_1724.method_23318(), z, onGround));
   }

   private boolean findCorner(double x, double z, BlockPos pos) {
      boolean minX = !OLEPOSSUtils.replaceable(pos.method_10093(Direction.field_11039));
      boolean minZ = !OLEPOSSUtils.replaceable(pos.method_10093(Direction.field_11043));
      boolean maxX = !OLEPOSSUtils.replaceable(pos.method_10093(Direction.field_11034));
      boolean maxZ = !OLEPOSSUtils.replaceable(pos.method_10093(Direction.field_11035));
