...
public class Burrow extends Module {
   ...
   public Burrow() {
      ...
      this.blocks = this.sgGeneral.bl("Blocks", "Blocks to use.", Blocks.field_10540, Blocks.field_10443);
      ...
      this.predicate = (itemStack) -> {
         Item patt4215$temp = itemStack.method_7909();
         if (patt4215$temp instanceof BlockItem) {
            BlockItem block = (BlockItem)patt4215$temp;
            ...
            if (rotated) {
               ...
               if (!switched) {
                  ...
                  if ((Boolean)this.instaRot.get() && SettingUtils.shouldRotate(RotationType.BlockPlace)) {
                     this.sendPacket(new LookAndOnGround(Managers.ROTATION.nextYaw, 90.0F, Managers.PACKET.isOnGround()));
                  }
                  ...
                  while(y < 1.1D) {
                     ...
                     this.sendPacket(new PositionAndOnGround(BlackOut.mc.field_1724.method_23317(), BlackOut.mc.field_1724.method_23318() + y, BlackOut.mc.field_1724.method_23321(), false));
                  }

                  this.placeBlock(hand, BlackOut.mc.field_1724.method_24515().method_10074().method_46558(), Direction.field_11036, BlackOut.mc.field_1724.method_24515().method_10074());
   ...
   public void onPacket(PacketEvent.Receive.Pre event) {
      if ((Boolean)this.pFly.get() && this.success && event.packet instanceof PlayerPositionLookS2CPacket) {
   ...
   private void lagBack(double y) {
      for(int i = 0; i < (Integer)this.lagBackPackets.get(); ++i) {
         this.sendPacket(new PositionAndOnGround(BlackOut.mc.field_1724.method_23317(), BlackOut.mc.field_1724.method_23318() + y + (Double)this.lagBackOffset.get(), BlackOut.mc.field_1724.method_23321(), false));
      }
      ...
      if ((Boolean)this.smooth.get()) {
         ...
         if ((Boolean)this.syncPacket.get()) {
            float yaw = MathHelper.method_15393(Managers.ROTATION.prevYaw);
            if (yaw < 0.0F) {
               yaw += 360.0F;
            }

            Managers.PACKET.sendInstantly(new Full(BlackOut.mc.field_1724.method_23317(), BlackOut.mc.field_1724.method_23318(), BlackOut.mc.field_1724.method_23321(), yaw, Managers.ROTATION.prevPitch, false));
         }
      }
