...
public class AutoPot extends Module {
   ...
   private final Predicate<ItemStack> healthPred;
   ...
   public AutoPot() {
      ...
      this.healthPred = (stack) -> {
         if (!(stack.method_7909() instanceof ThrowablePotionItem)) {
            return false;
         } else {
            Iterator var1 = PotionUtil.method_8067(stack).iterator();
            ...
            do {
               ...
               instance = (StatusEffectInstance)var1.next();
            } while(instance.method_5579() != StatusEffects.field_5915);
   ...
   private void update() {
      ...
      if (hand == null) {
         ...
         int b = hand == Hand.field_5808 ? Managers.PACKET.getStack().method_7947() : BlackOut.mc.field_1724.method_6079().method_7947();
   ...
   private boolean inDanger() {
      ...
      while(var1.hasNext()) {
         ...
         if (entity instanceof EndCrystalEntity && entity.field_6012 <= (Integer)this.maxExisted.get()) {
