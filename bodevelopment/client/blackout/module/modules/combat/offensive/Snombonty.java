...
public class Snombonty extends MoveUpdateModule {
   ...
   public Snombonty() {
      ...
      this.predicate = (stack) -> {
         return stack.method_31574(Items.field_8543) || stack.method_31574(Items.field_8803);
      };
   ...
   private void renderSpread(float tickDelta) {
      ...
      double x = MathHelper.method_16436((double)tickDelta, (this.prevBox.field_1323 + this.prevBox.field_1320) / 2.0D, (this.targetBox.field_1323 + this.targetBox.field_1320) / 2.0D) - cameraPos.field_1352;
      double y = MathHelper.method_16436((double)tickDelta, this.prevBox.field_1322, this.targetBox.field_1322) - cameraPos.field_1351 + (double)(this.target.method_17682() / 2.0F);
      double z = MathHelper.method_16436((double)tickDelta, (this.prevBox.field_1321 + this.prevBox.field_1324) / 2.0D, (this.targetBox.field_1321 + this.targetBox.field_1324) / 2.0D) - cameraPos.field_1350;
      ...
      this.stack.method_22907(RotationAxis.field_40716.rotation(-((float)Math.toRadians(RotationUtils.getYaw(BlackOut.mc.field_1773.method_19418().method_19326().method_1031(x, y, z), BlackOut.mc.field_1773.method_19418().method_19326(), 0.0D)))));
      this.stack.method_22907(RotationAxis.field_40714.rotation(-((float)Math.toRadians(pitch))));
   ...
   private Box lerpBox(float tickDelta, Box prev, Box current) {
      return new Box(MathHelper.method_16436((double)tickDelta, prev.field_1323, current.field_1323), MathHelper.method_16436((double)tickDelta, prev.field_1322, current.field_1322), MathHelper.method_16436((double)tickDelta, prev.field_1321, current.field_1321), MathHelper.method_16436((double)tickDelta, prev.field_1320, current.field_1320), MathHelper.method_16436((double)tickDelta, prev.field_1325, current.field_1325), MathHelper.method_16436((double)tickDelta, prev.field_1324, current.field_1324));
   }
         ...
         if (this.target != null) {
            ...
            label31: {
               ...
               if (var4 instanceof AbstractClientPlayerEntity) {
                  AbstractClientPlayerEntity pl = (AbstractClientPlayerEntity)var4;
   ...
   private int getBalls(Hand hand) {
      return Math.min((int)Math.floor(this.throwsLeft), hand == Hand.field_5808 ? Managers.PACKET.getStack().method_7947() : (hand == Hand.field_5810 ? BlackOut.mc.field_1724.method_6079().method_7947() : 0));
   }
   ...
   private void findTarget() {
      ...
      while(true) {
         ...
         do {
            ...
            } while((Boolean)this.onlyPlayers.get() && !(entity instanceof PlayerEntity));
