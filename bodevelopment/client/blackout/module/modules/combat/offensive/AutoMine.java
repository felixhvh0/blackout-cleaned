...
public class AutoMine extends Module {
   ...
   private final Setting<List<Block>> ignore;
   ...
   private BlockPos prevMined;
   private boolean shouldRestart;
   private final TimerList<BlockPos> crystals;
   private final List<PlayerEntity> enemies;
   ...
   public AutoMine() {
      ...
      this.prevState = Blocks.field_10124.method_9564();
   ...
   public void onSent(PacketEvent.Sent event) {
      if ((Boolean)this.resetOnSwitch.get() && event.packet instanceof UpdateSelectedSlotC2SPacket) {
      ...
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         ...
         if (this.minePos != null && this.mineType == AutoMine.MineType.Manual) {
            if ((Boolean)this.manualRangeReset.get() && !SettingUtils.inMineRange(this.minePos)) {
               ...
               BlockState state = BlackOut.mc.field_1687.method_8320(this.minePos);
               if (!(state.method_26204() instanceof AirBlock)) {
   ...
   private boolean paused(boolean placing) {
      if ((Boolean)(placing ? this.pauseEatPlacing : this.pauseEat).get() && BlackOut.mc.field_1724.method_6115()) {
         ...
         return (Boolean)this.pauseSword.get() && BlackOut.mc.field_1724.method_6047().method_7909() instanceof SwordItem;
      }
   }
   ...
   private void updateRender(float tickDelta) {
      ...
      if (this.prevMined != null) {
         ...
         p = MathHelper.method_16436((double)tickDelta, this.prevProgress, p);
         p = MathHelper.method_15350(p, 0.0D, 1.0D);
         ...
         Box box = this.getBox(p, (AutoMine.AnimationMode)this.animationMode.get());
         if (box != null) {
   ...
   private Box getBox(double sides, double up, double down) {
      ...
      VoxelShape shape = state.method_26218(BlackOut.mc.field_1687, this.minePos);
      if (shape.method_1110()) {
         return null;
      } else {
         Box from = shape.method_1107();
         Vec3d middle = BoxUtils.middle(from);
         Vec3d scale = new Vec3d(from.method_17939(), from.method_17940(), from.method_17941());
   ...
   private Box fromScale(Vec3d m, Vec3d s, double sides, double up, double down) {
      return new Box(m.field_1352 - sides * s.field_1352, m.field_1351 - down * s.field_1351, m.field_1350 - sides * s.field_1350, m.field_1352 + sides * s.field_1352, m.field_1351 + up * s.field_1351, m.field_1350 + sides * s.field_1350);
   }
   ...
   private double getProgress() {
      if (this.minePos == null) {
         ...
         ItemStack bestStack = this.findBestSlot((stack) -> {
   ...
   private AutoMine.Target getTarget() {
      ...
      return target == null ? new AutoMine.Target((BlockPos)null, (BlockPos)null, (AutoMine.MineType)null, 0, (PlayerEntity)null) : target;
   }
   ...
   private AutoMine.Target getCev() {
      ...
      while(var5.hasNext()) {
         ...
         BlockPos pos = new BlockPos(player.method_31477(), (int)Math.ceil(player.method_5829().field_1325), player.method_31479());
   ...
   private AutoMine.Target getTrapCev() {
      ...
      while(var5.hasNext()) {
         PlayerEntity player = (PlayerEntity)var5.next();
         BlockPos eyePos = new BlockPos(player.method_31477(), (int)Math.ceil(player.method_5829().field_1325) - 1, player.method_31479());
         Iterator var8 = Type.field_11062.iterator();

         while(var8.hasNext()) {
            Direction dir = (Direction)var8.next();
            BlockPos pos = eyePos.method_10093(dir);
   ...
   private AutoMine.Target getSurroundCev() {
      ...
      while(var5.hasNext()) {
         PlayerEntity player = (PlayerEntity)var5.next();
         BlockPos feetPos = new BlockPos(player.method_31477(), (int)Math.round(player.method_23318()), player.method_31479());
         Iterator var8 = Type.field_11062.iterator();

         while(var8.hasNext()) {
            Direction dir = (Direction)var8.next();
            BlockPos pos = feetPos.method_10093(dir);
   ...
   private AutoMine.Target getAutoCity() {
      ...
      while(var6.hasNext()) {
         ...
         BlockPos feetPos = new BlockPos(player.method_31477(), (int)Math.round(player.method_23318()), player.method_31479());
         Iterator var9 = Type.field_11062.iterator();
         ...
         while(true) {
            ...
            do {
                              ...
                              do {
                                 do {
                                    do {
                                       ...
                                       Direction dir = (Direction)var9.next();
               ...
               crystalFeet = new Vec3d((double)crystal.method_10263() + 0.5D, (double)crystal.method_10264(), (double)crystal.method_10260() + 0.5D);
   ...
   private AutoMine.Target getAntiBurrow() {
      ...
      while(var5.hasNext()) {
         ...
         if (SettingUtils.getPlaceOnDirection(pos) != null && SettingUtils.inMineRange(pos)) {
            if (this.isInstant(pos)) {
               return new AutoMine.Target(pos, (BlockPos)null, AutoMine.MineType.AntiBurrow, ((AutoMine.Priority)this.antiBurrowPriority.get()).priority, player);
            }
      ...
      return best == null ? null : new AutoMine.Target(best, (BlockPos)null, AutoMine.MineType.AntiBurrow, ((AutoMine.Priority)this.antiBurrowPriority.get()).priority, bestPlayer);
   }
   ...
   private boolean invalidCev(BlockPos pos, PlayerEntity player, Setting<Double> minDmg, Setting<Double> maxDmg, Setting<Boolean> dmgCheck) {
      if (!this.crystalBlock(pos, true)) {
         ...
         if (this.isInstant(pos)) {
            ...
            return !(entity instanceof EndCrystalEntity) && !(entity instanceof ExperienceOrbEntity) && !(entity instanceof ExperienceBottleEntity);
         })) {
            return true;
         } else {
            Vec3d crystalFeet = new Vec3d((double)pos.method_10263() + 0.5D, (double)(pos.method_10264() + 1), (double)pos.method_10260() + 0.5D);
   ...
   private boolean crystalBlock(BlockPos pos, boolean cev) {
      ...
      if (SettingUtils.oldCrystals() && !(this.getBlock(pos.method_10084()) instanceof AirBlock)) {
         return false;
      } else if (cev && bottom == Blocks.field_9987) {
         return false;
      } else if (!(this.getBlock(pos.method_10084()) instanceof AirBlock)) {
         return false;
      } else if (this.isInstant(pos)) {
         return true;
      } else {
         return bottom == Blocks.field_10540 || bottom == Blocks.field_9987;
      }
   }
   ...
   private void updateMining() {
      if (this.minePos != null && !this.startedThisTick) {
         ...
         ItemStack bestStack = holding ? Managers.PACKET.getStack() : BlackOut.mc.field_1724.method_31548().method_5438(slot);
   ...
   private void mineEndUpdate(boolean holding, int slot) {
      EndCrystalEntity crystalAt = this.crystalAt(this.crystalPos);
               ...
               if (!SettingUtils.endMineRot() || this.rotateBlock(this.minePos, dir, this.getMineEndRotationVec(), RotationType.Mining, "mining")) {
                  ...
                  if (holding || (switched = ((SwitchMode)this.pickaxeSwitch.get()).swap(slot))) {
                     this.sendSequenced((s) -> {
                        return new PlayerActionC2SPacket(Action.field_12973, this.minePos, dir, s);
                     });
                     SettingUtils.mineSwing(SwingSettings.MiningSwingState.End);
                     if ((Boolean)this.mineEndSwing.get()) {
                        this.clientSwing((SwingHand)this.mineHand.get(), Hand.field_5808);
                     }

                     if (!(Boolean)this.packet.get()) {
                        BlackOut.mc.field_1687.method_8501(this.minePos, Blocks.field_10124.method_9564());
                     }

                     Managers.BLOCK.set(this.minePos, Blocks.field_10124, true, true);
   ...
   public void onStart(BlockPos pos) {
      if (this.mineType == AutoMine.MineType.Manual && pos.equals(this.minePos)) {
         ...
         if ((Boolean)this.manualMine.get() && this.getBlock(pos) != Blocks.field_9987) {
            this.started = false;
            this.minePos = pos;
   ...
   private void start(BlockPos pos, boolean isRemine) {
      ...
      if (dir != null) {
         ...
         if (!pos.equals(this.prevMined)) {
            ...
            this.sendSequenced((s) -> {
               return new PlayerActionC2SPacket(Action.field_12968, pos, dir, s);
            });
   ...
   private void abort(BlockPos pos) {
      this.sendPacket(new PlayerActionC2SPacket(Action.field_12971, pos, Direction.field_11033, 0));
      this.started = false;
   }
   ...
   private Vec3d getMineEndRotationVec() {
      ...
      case Cev:
      case TrapCev:
         return new Vec3d((double)this.minePos.method_10263() + 0.5D, (double)(this.minePos.method_10264() + 1), (double)this.minePos.method_10260() + 0.5D);
      case SurroundCev:
      case SurroundMiner:
         return new Vec3d((double)this.minePos.method_10263() + 0.5D, (double)this.minePos.method_10264(), (double)this.minePos.method_10260() + 0.5D);
      case AutoCity:
         ...
         return new Vec3d((double)this.minePos.method_10263() + 0.5D + x, (double)this.minePos.method_10264() + 0.1D, (double)this.minePos.method_10260() + 0.5D + z);
      case Manual:
   ...
   private Vec3d getPlaceRotationVec(BlockPos pos) {
      ...
      case AutoCity:
         ...
         return new Vec3d((double)pos.method_10263() + 0.5D + x, (double)pos.method_10264() + 0.9D, (double)pos.method_10260() + 0.5D + z);
      case Manual:
      default:
         return new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264(), (double)pos.method_10260() + 0.5D);
      }
   }
   ...
   private static record Target(BlockPos pos, BlockPos crystal, AutoMine.MineType type, int priority, PlayerEntity target) {
      private Target(BlockPos pos, BlockPos crystal, AutoMine.MineType type, int priority, PlayerEntity target) {
         this.pos = pos;
