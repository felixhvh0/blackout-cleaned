...
public class CreeperAura extends Module {
   ...
   private void place() {
      ...
      if (data.valid()) {
         Hand hand = OLEPOSSUtils.getHand(Items.field_8503);
         FindResult result = ((SwitchMode)this.switchMode.get()).find(Items.field_8503);
   ...
   private void calcPos(BlockPos pos) {
      if (BlackOut.mc.field_1687.method_8320(pos).method_26204() instanceof AirBlock) {
