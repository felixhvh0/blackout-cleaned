...
public class AnchorAura extends Module {
   ...
   private void calcTarget(BlockPos pos) {
      if (BlackOut.mc.field_1687.method_8320(pos).method_26204() == Blocks.field_23152) {
         if (SettingUtils.getPlaceOnDirection(pos) != null) {
            if (SettingUtils.inInteractRange(pos)) {
               ...
               if (this.explodeDamageCheck()) {
                  ...
                  boolean isLoaded = (Integer)BlackOut.mc.field_1687.method_8320(pos).method_11654(Properties.field_23187) > 0;
   ...
   private void calcPos(BlockPos pos) {
      if (OLEPOSSUtils.replaceable(pos) || BlackOut.mc.field_1687.method_8320(pos).method_26204() == Blocks.field_23152) {
   ...
   private void updateInteract() {
      ...
      if (state.method_26204() == Blocks.field_23152 && (Integer)state.method_11654(Properties.field_23187) <= 0) {
   ...
   private void explode(BlockPos pos) {
      ...
      if (dir != null) {
         Predicate<ItemStack> predicate = (stack) -> {
            return stack.method_7909() != Items.field_8801;
         };
         ...
         if (hand != null || this.result.wasFound()) {
            PlaceData data = SettingUtils.getPlaceData(pos);
            Vec3d placeVec = data != null && data.valid() ? data.pos().method_46558().method_43206(data.dir(), 0.5D) : null;
   ...
   private void interact(BlockPos pos) {
      Direction dir = SettingUtils.getPlaceOnDirection(pos);
      if (dir != null) {
         Hand hand = OLEPOSSUtils.getHand(Items.field_8801);
         this.result = ((SwitchMode)this.switchMode.get()).find(Items.field_8801);
         if (hand != null || this.result.wasFound()) {
            PlaceData data = SettingUtils.getPlaceData(pos);
            Vec3d placeVec = data != null && data.valid() ? data.pos().method_46558().method_43206(data.dir(), 0.5D) : null;
            if (!SettingUtils.shouldRotate(RotationType.Interact) || this.rotateBlock(pos, dir, placeVec, RotationType.Interact, 0.05D, "interact")) {
               ...
               if (hand != null || (switched = ((SwitchMode)this.switchMode.get()).swap(this.result.slot()))) {
                  this.interactBlock(hand, pos.method_46558(), dir, pos);
                  RespawnAnchorBlock.method_26382(BlackOut.mc.field_1724, BlackOut.mc.field_1687, pos, BlackOut.mc.field_1687.method_8320(pos));
   ...
   private void place() {
      ...
      if (data.valid()) {
         Hand hand = OLEPOSSUtils.getHand(Items.field_23141);
         this.result = ((SwitchMode)this.switchMode.get()).find(Items.field_23141);
         if (hand != null || this.result.wasFound()) {
