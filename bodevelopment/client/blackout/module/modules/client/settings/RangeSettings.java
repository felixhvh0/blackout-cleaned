...
public class RangeSettings extends SettingsModule {
   ...
   public void onAttack(PacketEvent.Sent event) {
      ...
      if (var3 instanceof PlayerInteractEntityC2SPacket) {
         ...
         if (((AccessorInteractEntityC2SPacket)packet).getType().method_34211() == InteractType.field_29172) {
            Entity entity = BlackOut.mc.field_1687.method_8469(((AccessorInteractEntityC2SPacket)packet).getId());
            if (entity != null) {
   ...
   public void onTick(TickEvent.Pre event) {
      this.reducedAmount = MathHelper.method_15350(this.reducedAmount, 0.0D, (Double)this.reduceAmount.get());
   }

   private void registerAttack(Box bb) {
      double distance = this.attackRangeTo(bb, (Vec3d)null);
   ...
   public double interactRangeTo(BlockPos pos, Vec3d from) {
      ...
      Vec3d bottom = new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264(), (double)pos.method_10260() + 0.5D);
      double var10000;
   ...
   public double placeRangeTo(BlockPos pos, Vec3d from) {
      ...
      from = from.method_1031(0.0D, (double)BlackOut.mc.field_1724.method_18381(BlackOut.mc.field_1724.method_18376()), 0.0D);
      Vec3d feet = new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264(), (double)pos.method_10260() + 0.5D);
      double var10000;
   ...
   public double innerAttackRangeTo(Box bb, Vec3d from, boolean walls) {
      ...
      case NCP:
         ...
         var10000 = from.method_1022(new Vec3d(feet.field_1352, Math.min(Math.max(from.method_10214(), bb.field_1322), bb.field_1325), feet.field_1350));
         break;
      case Vanilla:
         ...
         break;
      case Middle:
         var10000 = from.method_1022(new Vec3d((bb.field_1323 + bb.field_1320) / 2.0D, (bb.field_1322 + bb.field_1325) / 2.0D, (bb.field_1321 + bb.field_1324) / 2.0D));
         break;
      case CustomBox:
      ...
      case UpdatedNCP:
         feet = BoxUtils.feet(bb);
         var10000 = from.method_1022(new Vec3d(feet.field_1352, Math.min(Math.max(from.method_10214(), bb.field_1322), bb.field_1325), feet.field_1350)) - this.getDistFromCenter(bb, feet, from);
         break;
      case Simple:
   ...
   public double getDistFromCenter(Box bb, Vec3d feet, Vec3d from) {
      Vec3d pos = new Vec3d(feet.field_1352, feet.field_1351, feet.field_1350);
      Vec3d vec1 = new Vec3d(from.method_10216() - pos.method_10216(), 0.0D, from.method_10215() - pos.method_10215());
      double halfWidth = bb.method_17939() / 2.0D;
      if (vec1.method_1033() < halfWidth * (double)MathHelper.field_15724) {
         return 0.0D;
      } else {
         ...
         Vec3d vec2 = new Vec3d(pos.method_10216() - feet.method_10216(), 0.0D, pos.method_10215() - feet.method_10215());
