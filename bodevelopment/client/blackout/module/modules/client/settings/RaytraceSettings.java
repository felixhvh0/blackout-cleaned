...
public class RaytraceSettings extends SettingsModule {
   ...
   private boolean blockTrace(BlockPos pos, boolean ncp, Setting<RaytraceSettings.PlaceTraceMode> mode, Setting<Double> exposure, Setting<Double> ph, Setting<Double> ph1, Setting<Double> ph2) {
      this.updateContext();
      Vec3d vec;
      int x;
      int y;
      ...
      case SinglePoint:
         vec = new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264() + (Double)ph.get(), (double)pos.method_10260() + 0.5D);
         if (ncp) {
         ...
         return this.result.method_17783() == Type.field_1333 || this.result.method_17777().equals(pos);
      case DoublePoint:
         vec = new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264() + (Double)ph1.get(), (double)pos.method_10260() + 0.5D);
         Vec3d to2 = new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264() + (Double)ph2.get(), (double)pos.method_10260() + 0.5D);
         if (ncp) {
         ...
         return this.result.method_17783() == Type.field_1333 || this.result.method_17777().equals(pos);
      case Sides:
         vec = new Vec3d((double)pos.method_10263() + 0.5D, (double)pos.method_10264() + 0.5D, (double)pos.method_10260() + 0.5D);
         Direction[] var14 = Direction.values();
         y = var14.length;

         for(z = 0; z < y; ++z) {
            Direction dir = var14[z];
            Vec3d vec2 = vec.method_1031((double)((float)dir.method_10148() / 2.0F), (double)((float)dir.method_10164() / 2.0F), (double)((float)dir.method_10165() / 2.0F));
            if (ncp) {
            ...
            this.result = DamageUtils.raycast(this.raycastContext, false);
            if (this.result.method_17783() == Type.field_1333 || this.result.method_17777().equals(pos)) {
               return true;
            }
         }
         ...
         return false;
      case Exposure:
         vec = new Vec3d((double)pos.method_10263(), (double)pos.method_10264(), (double)pos.method_10260());
         this.hit = 0;
   ...
   public boolean attackTrace(Box box) {
      if (!(Boolean)this.attackTrace.get()) {
         ...
         case SinglePoint:
            vec = new Vec3d((box.field_1323 + box.field_1320) / 2.0D, box.field_1322 + (Double)this.attackHeight.get(), (box.field_1321 + box.field_1324) / 2.0D);
            if ((Boolean)this.attackNCP.get()) {
               return this.ncpRaytrace(vec, box);
            }

            ((IRaycastContext)DamageUtils.raycastContext).blackout_Client$set(BlackOut.mc.field_1724.method_33571(), vec, ShapeType.field_17558, FluidHandling.field_1348, BlackOut.mc.field_1724);
            return DamageUtils.raycast(DamageUtils.raycastContext, false).method_17783() != Type.field_1332;
         case DoublePoint:
            vec = new Vec3d((box.field_1323 + box.field_1320) / 2.0D, box.field_1322 + (Double)this.attackHeight1.get(), (box.field_1321 + box.field_1324) / 2.0D);
            Vec3d to2 = new Vec3d((box.field_1323 + box.field_1320) / 2.0D, box.field_1322 + (Double)this.attackHeight2.get(), (box.field_1321 + box.field_1324) / 2.0D);
            if (!(Boolean)this.attackNCP.get()) {
               ((IRaycastContext)DamageUtils.raycastContext).blackout_Client$set(BlackOut.mc.field_1724.method_33571(), vec, ShapeType.field_17558, FluidHandling.field_1348, BlackOut.mc.field_1724);
               if (DamageUtils.raycast(DamageUtils.raycastContext, false).method_17783() != Type.field_1332) {
                  return true;
               }

               ((IRaycastContext)DamageUtils.raycastContext).blackout_Client$set(BlackOut.mc.field_1724.method_33571(), to2, ShapeType.field_17558, FluidHandling.field_1348, BlackOut.mc.field_1724);
               return DamageUtils.raycast(DamageUtils.raycastContext, false).method_17783() != Type.field_1332;
            }

            return this.ncpRaytrace(vec, box) || this.ncpRaytrace(to2, box);
         case Exposure:
            vec = new Vec3d(box.field_1323, box.field_1322, box.field_1321);
            xl = box.method_17939();
            yl = box.method_17940();
            zl = box.method_17941();
            this.hit = 0;
            ...
            for(x = 0; x <= 2; ++x) {
               for(y = 0; y <= 2; ++y) {
                  for(z = 0; z <= 2; ++z) {
                     vec2 = vec.method_1031(MathHelper.method_16436((double)((float)x / 2.0F), xl * 0.1D, xl * 0.9D), MathHelper.method_16436((double)((float)y / 2.0F), yl * 0.1D, yl * 0.9D), MathHelper.method_16436((double)((float)z / 2.0F), zl * 0.1D, zl * 0.9D));
                     if ((Boolean)this.attackNCP.get()) {
                        ...
                        ((IRaycastContext)this.raycastContext).blackout_Client$setEnd(vec2);
                        this.result = DamageUtils.raycast(this.raycastContext, false);
                        if (this.result.method_17783() != Type.field_1332) {
                           ++this.hit;
   ...
   private void updateContext() {
      if (this.raycastContext == null) {
         this.raycastContext = new RaycastContext(BlackOut.mc.field_1724.method_33571(), (Vec3d)null, ShapeType.field_17558, FluidHandling.field_1347, BlackOut.mc.field_1724);
      } else {
