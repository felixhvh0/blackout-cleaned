...
public class Notifications extends SettingsModule {
   ...
   private final Setting<Formatting> nameColor;
   private final Setting<Formatting> bracketColor;
   private final Setting<Formatting> txtColor;
   ...
   public Notifications() {
      ...
      this.nameColor = this.sgRender.e("Name Color", Formatting.field_1061, ".");
      this.bracketColor = this.sgRender.e("Bracket Color", Formatting.field_1063, ".");
      this.txtColor = this.sgRender.e("Chat Text Color", Formatting.field_1068, ".");
      INSTANCE = this;
   }
   ...
   public float render(MatrixStack stack, NotificationManager.Notification n, float offset) {
      ...
      stack.method_22909();
      return MathHelper.method_16439((float)delta, returnHeight, returnHeight + 20.0F);
   }
