...
public class PhaseESP extends Module {
   ...
   public void renderNameTag(double tickDelta, Entity entity) {
      ...
      Vec2f f = RenderUtils.getCoords(x, y - (Double)this.yOffset.get(), z, true);
      if (f == null) {
         ...
         double easedValue = AnimUtils.easeOutQuint(MathHelper.method_15350((double)d / 100.0D, 0.0D, 1.0D));
