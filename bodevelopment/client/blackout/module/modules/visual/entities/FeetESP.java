...
public class FeetESP extends Module {
   ...
   public void onRender(RenderEvent.World.Post event) {
      if (BlackOut.mc.field_1687 != null && BlackOut.mc.field_1724 != null) {
         ...
         Render3DUtils.start();
         Vec3d vec = BlackOut.mc.field_1773.method_19418().method_19326();
   ...
   private void drawVertexes(boolean outline, ColorRenderer renderer) {
      ...
      if (outline) {
         ...
         renderer.startRender(Render3DUtils.matrices, DrawMode.field_27382);
      }
      ...
      BlackOut.mc.field_1687.method_18112().forEach((entity) -> {
         if (((List)this.entities.get()).contains(entity.method_5864())) {
            ...
            Vec3d pos = (new Vec3d(entity.field_6014, entity.field_6036, entity.field_5969)).method_35590(entity.method_19538(), (double)BlackOut.mc.method_1488());
