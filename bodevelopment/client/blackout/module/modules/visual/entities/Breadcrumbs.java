...
public class Breadcrumbs extends Module {
   ...
   private final RenderList<Vec3d> list;
   ...
   private void addDot(double tickDelta, Entity entity) {
      if (!(Boolean)this.onlyMoving.get() || entity.field_6014 != entity.method_23317() || entity.field_6036 != entity.method_23318() || entity.field_5969 != entity.method_23321()) {
         ...
         this.list.add(new Vec3d(x, y, z), (Double)this.renderTime.get());
      }
   }

   private void drawDot(MatrixStack stack, Vec3d vec, double delta) {
      Vec2f f = RenderUtils.getCoords(vec.field_1352, vec.field_1351, vec.field_1350, true);
      if (f != null) {
