...
public class ESP extends Module {
   ...
   public void render2D(double tickDelta, Vec3d cameraPos, Entity entity) {
      double x = MathHelper.method_16436(tickDelta, entity.field_6014, entity.method_23317()) - cameraPos.field_1352;
      double y = MathHelper.method_16436(tickDelta, entity.field_6036, entity.method_23318()) - cameraPos.field_1351 + (double)(entity.method_17682() / 2.0F);
      double z = MathHelper.method_16436(tickDelta, entity.field_5969, entity.method_23321()) - cameraPos.field_1350;
      float s = 1.25F;
      double cameraPitch = (double)Math.abs(BlackOut.mc.field_1773.method_19418().method_19329() / 90.0F);
      double anglePitch = Math.abs(RotationUtils.getPitch(new Vec3d(x, y, z), Vec3d.field_1353) / 90.0D);
      double yaw1 = 90.0D - Math.abs(90.0D - Math.abs(RotationUtils.yawAngle((double)(BlackOut.mc.field_1773.method_19418().method_19330() + 180.0F), RotationUtils.getYaw(new Vec3d(x, y, z), Vec3d.field_1353, 0.0D))));
      ...
      this.stack.method_22907(RotationAxis.field_40716.rotation((float)Math.toRadians((double)(-BlackOut.mc.field_1773.method_19418().method_19330() + 180.0F))));
      this.stack.method_22907(RotationAxis.field_40714.rotation((float)Math.toRadians((double)BlackOut.mc.field_1773.method_19418().method_19329())));
      ...
      if ((Boolean)this.renderItem.get() && entity instanceof AbstractClientPlayerEntity && ((AbstractClientPlayerEntity)entity).method_6047() != null) {
         String stackName = ((AbstractClientPlayerEntity)entity).method_6047().method_7964().getString();
   ...
   private float getWidth(Box box, double pitch) {
      return (float)MathHelper.method_16436(Math.sin(pitch * 3.141592653589793D / 2.0D), box.method_17939(), box.method_17940());
   }

   private float getHeight(Box box, double pitch) {
      return (float)MathHelper.method_16436(Math.sin(pitch * 3.141592653589793D / 2.0D), box.method_17940(), box.method_17939());
   }
   ...
   public static enum NameMode {
      ...
      private NameMode(Function<Entity, String> function) {
