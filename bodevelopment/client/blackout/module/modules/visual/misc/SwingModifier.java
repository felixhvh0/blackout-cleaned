...
public class SwingModifier extends Module {
   ...
   public float getSwing(Hand hand) {
      return hand == Hand.field_5808 ? (float)((Double)this.mainStart.get() + ((Double)this.mainEnd.get() - (Double)this.mainStart.get()) * (double)this.mainProgress) : (float)((Double)this.offStart.get() + ((Double)this.offEnd.get() - (Double)this.offStart.get()) * (double)this.offProgress);
   }

   public float getY(Hand hand) {
      return hand == Hand.field_5808 ? (float)((Double)this.mainStartY.get() + ((Double)this.mainEndY.get() - (Double)this.mainStartY.get()) * (double)this.mainProgress) / -10.0F : (float)((Double)this.offStartY.get() + ((Double)this.offEndY.get() - (Double)this.offStartY.get()) * (double)this.offProgress) / -10.0F;
   }
}
