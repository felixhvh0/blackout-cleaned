...
public class Highlight extends Module {
   ...
   private final Map<BlockPos, MutableDouble> alphas;
   ...
   private void moveRender(Box box, double frameTime) {
      ...
      if (this.middle != null) {
         Box box1 = new Box(this.middle.method_10216() - this.lx / 2.0D, this.middle.method_10214() - this.ly / 2.0D, this.middle.method_10215() - this.lz / 2.0D, this.middle.method_10216() + this.lx / 2.0D, this.middle.method_10214() + this.ly / 2.0D, this.middle.method_10215() + this.lz / 2.0D);
   ...
   private void movePos(double frameTime) {
      if (this.targetPos != null) {
         if (this.alpha <= 0.0D) {
            ...
            Vec3d diff = this.targetPos.method_1020(this.middle);
