...
public class ViewModel extends Module {
   ...
   public void scaleAndRotate(MatrixStack stack, Hand hand) {
      ...
      stack.method_22907(RotationAxis.field_40714.rotationDegrees(((Double)rotX.get()).floatValue() + rotationX));
      stack.method_22907(RotationAxis.field_40716.rotationDegrees(((Double)rotY.get()).floatValue() + rotationY));
      stack.method_22907(RotationAxis.field_40718.rotationDegrees(((Double)rotZ.get()).floatValue() + rotationZ));
