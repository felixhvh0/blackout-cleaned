...
public class FovModifier extends Module {
   ...
   public void onRender(RenderEvent.World.Pre event) {
      this.progress = MathHelper.method_15350(this.progress + (((KeyBind)this.zoomKey.get()).isPressed() ? event.frameTime / (Double)this.zoomTime.get() : -event.frameTime / (Double)this.zoomTime.get()), 0.0D, 1.0D);
   }

   public double getFOV() {
      return MathHelper.method_16436(AnimUtils.easeInOutCubic(this.progress), (Double)this.fov.get(), (Double)this.zoom.get());
   }
}
