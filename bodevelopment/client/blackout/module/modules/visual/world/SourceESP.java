...
public class SourceESP extends Module {
   ...
   private final List<Pair<BlockPos, Boolean>> sources;
   ...
   private void renderShader(Pair<BlockPos, Boolean> pair) {
      Render3DUtils.box(BoxUtils.get((BlockPos)pair.method_15442()), this.white, (BlackOutColor)null, RenderShape.Sides);
   }
         ...
         for(int y = -r; y <= r; ++y) {
            for(int z = -r; z <= r; ++z) {
               if (!((double)(x * x + y * y + z * z) > rangeSq)) {
                  ...
                  FluidState fluidState = BlackOut.mc.field_1687.method_8316(pos);
                  if (!fluidState.method_15769() && fluidState.method_15771()) {
                     ...
                     } else if ((Boolean)this.lava.get() && fluidState.method_15767(FluidTags.field_15518)) {
