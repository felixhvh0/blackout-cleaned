...
public class SoundESP extends Module {
   ...
   public SoundESP() {
      ...
      this.sounds = this.sgGeneral.r("Sounds", ".", Registries.field_41172, (sound) -> {
   ...
   private void draw(double x, double y, double z, String string, double time, Vec3d camPos) {
      ...
      if (f != null) {
         double alpha = MathHelper.method_15350(this.getAlpha(time), 0.0D, 1.0D);
