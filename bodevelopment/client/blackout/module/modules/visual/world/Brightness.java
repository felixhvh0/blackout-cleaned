...
public class Brightness extends Module {
   ...
   public void onDisable() {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         if (this.mode.get() == Brightness.Mode.Effect && BlackOut.mc.field_1724.method_6059(StatusEffects.field_5925)) {
            BlackOut.mc.field_1724.method_6016(StatusEffects.field_5925);
         }
   ...
   public void onTick(TickEvent.Pre event) {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         if (this.mode.get() == Brightness.Mode.Effect) {
            BlackOut.mc.field_1724.method_6092(new StatusEffectInstance(StatusEffects.field_5925, 69, 0));
         }
