...
public class Playerlist extends HudElement {
   ...
   public void render() {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         ...
         this.players.forEach((player) -> {
            ...
            PlayerListEntry entry = BlackOut.mc.method_1562().method_2871(current.method_5667());
   ...
   private void drawText(MatrixStack stack, float x, float y, String string, String string2, String string3, String string4, Boolean first, float health, float ping, float totemPops) {
   ...
   public boolean shouldRender(Entity entity) {
      ...
      return entity != BlackOut.mc.field_1724 && entity instanceof AbstractClientPlayerEntity;
   }
