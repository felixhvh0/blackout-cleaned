...
public class Effects extends HudElement {
   ...
   public void render() {
      if (BlackOut.mc.field_1724 != null && BlackOut.mc.field_1687 != null) {
         if (BlackOut.mc.field_1724.method_6088() != null) {
            ...
            Comparator<Entry<StatusEffect, StatusEffectInstance>> comparator = Comparator.comparingDouble(this::getWidth);
            BlackOut.mc.field_1724.method_6088().entrySet().stream().sorted(this.order.get() == Effects.Order.Shortest ? comparator : comparator.reversed()).forEach((entry) -> {
               this.stack.method_46416(0.0F, this.render((StatusEffect)entry.getKey(), (StatusEffectInstance)entry.getValue()), 0.0F);
            });
   ...
   private float getWidth(Entry<StatusEffect, StatusEffectInstance> entry) {
      return this.getWidth((StatusEffect)entry.getKey(), (StatusEffectInstance)entry.getValue());
   }
