...
public class TargetHUD extends HudElement {
   ...
   private AbstractClientPlayerEntity renderTarget;
   ...
   public TargetHUD() {
      ...
      this.renderPos = Vec3d.field_1353;
   ...
   public void onRender(RenderEvent.Hud.Post event) {
      if (BlackOut.mc.field_1687 != null && BlackOut.mc.field_1724 != null) {
         if (this.renderType.get() != TargetHUD.RenderType.Hud && this.renderTarget != null) {
            ...
            Vec2f f = RenderUtils.getCoords(this.renderPos.field_1352 + Math.cos(yaw) * (Double)this.dist.get(), this.renderPos.field_1351 + this.renderTarget.method_5829().method_17940() * (Double)this.renderHeight.get(), this.renderPos.field_1350 + Math.sin(yaw) * (Double)this.dist.get(), true);
            if (f == null) {
   ...
   private void setRendering(AbstractClientPlayerEntity player) {
      ...
      this.renderPos = new Vec3d(MathHelper.method_16436((double)BlackOut.mc.method_1488(), this.renderTarget.field_6014, this.renderTarget.method_23317()), MathHelper.method_16436((double)BlackOut.mc.method_1488(), this.renderTarget.field_6036, this.renderTarget.method_23318()), MathHelper.method_16436((double)BlackOut.mc.method_1488(), this.renderTarget.field_5969, this.renderTarget.method_23321()));
   }
   ...
   private void renderTargetHUD(boolean center) {
      ...
      case BlackoutInfo:
         txt = "0";
         PlayerListEntry entry = BlackOut.mc.method_1562().method_2871(this.renderTarget.method_5667());
         if (entry != null) {
   ...
   private void drawArmor(MatrixStack stack, PlayerEntity player, float x, float y) {
      ...
      case ExhibitionNew:
         for(i = 0; i < 4; ++i) {
            itemStack = (ItemStack)player.method_31548().field_7548.get(3 - i);
   ...
   private float getDurability(PlayerEntity entity) {
      ...
      for(int i = 0; i < 4; ++i) {
         if (entity.method_31548().method_7372(i).method_7960()) {
            ...
            ItemStack itemStack = entity.method_31548().method_7372(i);
            ++armors;
