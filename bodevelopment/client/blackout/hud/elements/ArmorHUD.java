...
public class ArmorHUD extends HudElement {
   ...
   private void draw(MatrixStack stack) {
      ...
      for(int i = 0; i < 4; ++i) {
         ItemStack itemStack = (ItemStack)BlackOut.mc.field_1724.method_31548().field_7548.get((Boolean)this.reversed.get() ? i : 3 - i);
   ...
   private boolean armorFound() {
      for(int i = 0; i < 4; ++i) {
         ItemStack itemStack = (ItemStack)BlackOut.mc.field_1724.method_31548().field_7548.get(i);
         if (!itemStack.method_7960()) {
            return true;
         }
      }
