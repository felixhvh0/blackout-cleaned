...
public class HudElementList {
   ...
   private float clampLerpProgress(float val, float start, float end) {
      return MathHelper.method_15363(MathHelper.method_37960(val, start, end), 0.0F, 1.0F);
   }
   ...
   private float getHeight() {
      return MathHelper.method_16439((float)AnimUtils.easeInOutCubic((double)this.clampLerpProgress(this.openProgress, 0.5F, 1.0F)), 40.0F, (float)BlackOut.mc.method_22683().method_4507() * 0.5F);
   }
